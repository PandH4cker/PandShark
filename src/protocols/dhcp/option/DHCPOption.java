...
public enum DHCPOption {
    ...
    DHCPOption(final Integer code, final String name) {
        this.code = code;
        this.name = name;
    }

    public static DHCPOption fromCode(final Integer code) throws UnknownDHCPOption {
        for(DHCPOption opt : DHCPOption.values())
